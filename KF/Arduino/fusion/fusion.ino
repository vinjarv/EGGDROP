...
{ 
  ...
  if(packet_size) 
  {
    ...
    sensor_values.concat(String(accel[0], 6)); sensor_values.concat(",");
    sensor_values.concat(String(accel[1], 6)); sensor_values.concat(",");
    sensor_values.concat(String(accel[2], 6)); sensor_values.concat(",");
